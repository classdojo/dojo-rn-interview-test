# ASSIGNMENT: Awards Visualizer

## DESCRIPTION:
Today, you're going to implement a design mock for a portion of a mobile app.
...
* Visual mocks
  - [Figma File](https://www.figma.com/file/P6lJdhODJhT6aMTgF3xtCH/Dojo-RN-Interview?type=design&node-id=2%3A3&mode=design&t=2PAlU9WoulNWTkBd-1)
...
These notes may or may not be relevant to your implementation

This is an Expo EAS managed project, so not all libraries will work. Some of those are listed below:
